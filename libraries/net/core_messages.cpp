...
static_assert((int)mcc::net::block_message_type == (int)mcc::client::block_message_type, "enum values don't match");
static_assert((int)mcc::net::trx_message_type == (int)mcc::client::trx_message_type, "enum values don't match");
