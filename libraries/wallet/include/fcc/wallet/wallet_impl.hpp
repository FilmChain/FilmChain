...
namespace mcc { namespace wallet { namespace detail {
...
class wallet_impl : public chain_observer
{
   public:
      ...
      bool scan_asset_update_permissions(const asset_update_permissions_operation &op, wallet_transaction_record& trx_rec);
      ...
      bool scan_deposit_to_asset(const deposit_to_asset_operation& op, wallet_transaction_record& trx_rec, asset& total_fee);
