...
namespace fc
{
   void to_variant( const mcc::blockchain::pts_address& var,  variant& vo )
   {
        vo = std::string(var);
   }
   void from_variant( const variant& var,  mcc::blockchain::pts_address& vo )
   {
        vo = mcc::blockchain::pts_address( var.as_string() );
   }
}
