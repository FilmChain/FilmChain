...
struct withdraw_operation
{
    ...
    withdraw_operation( const balance_id_type& id, share_type amount_arg,const asset_id_type& asset_id )
        :balance_id(id),amount(amount_arg), asset_id(asset_id){ FC_ASSERT( amount_arg > 0 ); }
...
FC_REFLECT( mcc::blockchain::withdraw_operation, (balance_id)(amount)(asset_id)(claim_input_data) )
FC_REFLECT( mcc::blockchain::deposit_operation, (amount)(condition) )
FC_REFLECT( mcc::blockchain::burn_operation, (amount)(account_id)(message)(message_signature) )
FC_REFLECT( mcc::blockchain::release_escrow_operation, (escrow_id)(released_by)(amount_to_receiver)(amount_to_sender) )
FC_REFLECT( mcc::blockchain::update_balance_vote_operation, (balance_id)(new_restricted_owner)(new_slate) )
FC_REFLECT( mcc::blockchain::limit_fee_operation, (max_fee) )
