...
namespace mcc { namespace blockchain {
   ...
   struct transaction
   {
      ...
      void uia_update_authority(const asset_id_type asset_id, const multisig_meta_info& multisig);
      ...
      void deposit_to_asset(const asset& deposit_asset, const asset_id_type& target_asset);
...
FC_REFLECT( mcc::blockchain::transaction, (expiration)(reserved)(operations) )
FC_REFLECT_DERIVED( mcc::blockchain::signed_transaction, (mcc::blockchain::transaction), (signatures) )
FC_REFLECT( mcc::blockchain::transaction_location, (block_num)(trx_num) )
