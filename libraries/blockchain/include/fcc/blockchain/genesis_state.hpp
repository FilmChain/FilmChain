...
FC_REFLECT( mcc::blockchain::genesis_asset, (symbol)(name)(description)(precision) )
FC_REFLECT( mcc::blockchain::genesis_delegate, (name)(owner) )
FC_REFLECT( mcc::blockchain::genesis_balance, (raw_address)(balance) )
FC_REFLECT( mcc::blockchain::genesis_vesting_balances, (start_time)(duration_days)(vesting_balances) )
FC_REFLECT( mcc::blockchain::genesis_state, (timestamp)(market_assets)(delegates)(initial_balances)(sharedrop_balances) )
