...
#include <fcc/blockchain/burn_record.hpp>
#include <fcc/blockchain/condition.hpp>
#include <fcc/blockchain/feed_record.hpp>
#include <fcc/blockchain/market_records.hpp>
#include <fcc/blockchain/property_record.hpp>
#include <fcc/blockchain/slate_record.hpp>
#include <fcc/blockchain/slot_record.hpp>
#include <fcc/blockchain/status_record.hpp>
#include <fcc/blockchain/transaction_record.hpp>
...
namespace mcc { namespace blockchain {
     ...
     public slot_db_interface
   {
      public:
         ...
         void                               store_deposit_to_asset_record(const deposit_asset_record& record);
         odeposit_asset_record              get_deposit_to_asset_record(const transaction_id_type& id) const;
