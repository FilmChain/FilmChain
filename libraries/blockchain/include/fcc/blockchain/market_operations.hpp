...
FC_REFLECT_DERIVED( mcc::blockchain::market_index_key_ext, (mcc::blockchain::market_index_key), (limit_price) )
FC_REFLECT( mcc::blockchain::bid_operation, (amount)(bid_index) )
FC_REFLECT( mcc::blockchain::ask_operation, (amount)(ask_index) )
FC_REFLECT( mcc::blockchain::short_operation, (amount)(short_index) )
FC_REFLECT( mcc::blockchain::short_operation_v1, (amount)(short_index) )
FC_REFLECT( mcc::blockchain::cover_operation, (amount)(cover_index)(reserved) )
FC_REFLECT( mcc::blockchain::add_collateral_operation, (amount)(cover_index) )
