...
FC_REFLECT( mcc::blockchain::block_header,
            (previous)(block_num)(timestamp)(transaction_digest)(next_secret_hash)(previous_secret) )
FC_REFLECT_DERIVED( mcc::blockchain::signed_block_header, (mcc::blockchain::block_header), (delegate_signature) )
FC_REFLECT_DERIVED( mcc::blockchain::full_block, (mcc::blockchain::signed_block_header), (user_transactions) )
FC_REFLECT_DERIVED( mcc::blockchain::digest_block, (mcc::blockchain::signed_block_header), (user_transaction_ids) )
