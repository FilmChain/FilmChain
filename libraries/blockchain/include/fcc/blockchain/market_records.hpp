...
namespace mcc { namespace blockchain {
   ...
   struct market_history_stat
   {
       ...
       share_type  stat_base_volume;
       share_type  stat_quote_volume;

       bool operator == (const market_history_stat& other) const
       {
           return std::tie(stat_highest, stat_lowest, stat_opening, stat_closing, stat_base_volume, stat_quote_volume)
               == std::tie(other.stat_highest, other.stat_lowest, other.stat_opening, other.stat_closing, other.stat_base_volume, other.stat_quote_volume);
       }
...
FC_REFLECT_ENUM( mcc::blockchain::order_type_enum,
                 (null_order)
                 (bid_order)
                 (ask_order)
                 (short_order)
...
FC_REFLECT_ENUM( mcc::blockchain::market_history_key::time_granularity_enum, (each_block)(each_hour)(each_day) )
FC_REFLECT( mcc::blockchain::market_index_key, (order_price)(owner) )
FC_REFLECT( mcc::blockchain::market_history_record, (highest_bid)(lowest_ask)(opening_price)(closing_price)(base_volume)(quote_volume) )
FC_REFLECT( mcc::blockchain::market_history_stat, (stat_highest)(stat_lowest)(stat_opening)(stat_closing)(stat_base_volume)(stat_quote_volume))
FC_REFLECT( mcc::blockchain::market_history_key, (quote_id)(base_id)(granularity)(timestamp) )
FC_REFLECT( mcc::blockchain::market_history_point, (timestamp)(highest_bid)(lowest_ask)(opening_price)(closing_price)(base_volume)(quote_volume) )
FC_REFLECT( mcc::blockchain::order_record, (balance)(limit_price)(last_update) )
FC_REFLECT( mcc::blockchain::collateral_record, (collateral_balance)(payoff_balance)(interest_rate)(expiration) )
FC_REFLECT( mcc::blockchain::market_order, (type)(market_index)(state)(collateral)(interest_rate)(expiration) )
FC_REFLECT_TYPENAME( std::vector<mcc::blockchain::market_transaction> )
FC_REFLECT_TYPENAME( mcc::blockchain::market_history_key::time_granularity_enum ) // http://en.wikipedia.org/wiki/Voodoo_programminqg
FC_REFLECT( mcc::blockchain::market_transaction,
            (bid_type)
            (ask_type)
            (bid_index)
            (ask_index)
...
FC_REFLECT_DERIVED( mcc::blockchain::order_history_record, (mcc::blockchain::market_transaction), (timestamp) )
