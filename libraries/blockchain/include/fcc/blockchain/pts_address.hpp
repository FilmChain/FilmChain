...
{
   template<>
   struct hash<mcc::blockchain::pts_address> 
   {
       public:
         size_t operator()(const mcc::blockchain::pts_address &a) const 
         {
            size_t s;
...
FC_REFLECT( mcc::blockchain::pts_address, (addr) )

namespace fc 
{ 
   void to_variant( const mcc::blockchain::pts_address& var,  fc::variant& vo );
   void from_variant( const fc::variant& var,  mcc::blockchain::pts_address& vo );
}
