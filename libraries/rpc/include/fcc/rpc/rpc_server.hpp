...
namespace mcc { namespace rpc {
  ...
  /**
  *  @class rpc_server
  *  @brief provides a json-rpc interface to the mcc client
  */
  class rpc_server
  {
     public:
       rpc_server(mcc::client::client* client);
       virtual ~rpc_server();

       bool        configure_rpc(const mcc::client::rpc_server_config& cfg);
       bool        configure_http(const mcc::client::rpc_server_config& cfg);
       bool        configure_websockets(const mcc::client::rpc_server_config& cfg);
       bool        configure_encrypted_rpc(const mcc::client::rpc_server_config& cfg);
       ...
       const mcc::api::method_data& get_method_data(const std::string& method_name);
       std::vector<mcc::api::method_data> get_all_method_data() const;
     ...
     protected:
       friend class mcc::rpc::detail::rpc_server_impl;

       void validate_method_data(mcc::api::method_data method);
       void register_method(mcc::api::method_data method);
