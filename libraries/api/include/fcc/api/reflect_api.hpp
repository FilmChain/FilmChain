...
FC_API( mcc::api::wallet_api, (wallet_unlock) )
...
namespace mcc { namespace api {
   ...
   struct login_api 
   {
      public:
         ...
         fc::api<mcc::api::blockchain_api> get_blockchain()const
         {
            FC_ASSERT( _blockchain, "no permission to access blockchain" );
            return *_blockchain;
         }
         fc::api<mcc::api::wallet_api>     get_wallet()const
         {
            FC_ASSERT( _wallet, "no permission to access wallet" );
            return *_wallet;
         }

         optional<fc::api<mcc::api::blockchain_api>> _blockchain;
         optional<fc::api<mcc::api::wallet_api>>     _wallet;
         map<string,permissions>                     _permissions;
         common_api* _capi = nullptr;
   };
} } // mcc::api

FC_REFLECT( mcc::api::permissions, (password)(access) );
FC_API( mcc::api::login_api, (login)(get_blockchain)(get_wallet) )
