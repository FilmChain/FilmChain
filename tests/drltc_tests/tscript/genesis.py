...
MCC_BLOCKCHAIN_MAX_SHARES = (1000*1000*1000*1000*1000)
MCC_BLOCKCHAIN_INITIAL_SHARES = (MCC_BLOCKCHAIN_MAX_SHARES // 5)

total_balance = sum(b["balance"] for b in balances)

ballast_keys = create_keys("ballast", 1)
ballast_balance = MCC_BLOCKCHAIN_INITIAL_SHARES - total_balance
