...
#include <mcc/net/node.hpp>
#include <mcc/client/messages.hpp>
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
class simple_net_test_miner : public mcc::net::node_delegate
{
   private:
     node _node;
     ...
     {
       mcc::blockchain::signed_transaction transaction;
