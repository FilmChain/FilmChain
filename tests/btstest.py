...
class ClientProcess(object):
    ...
    default_client_exe = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "programs", "client", "mccsharestestnet_client"))
...
class Test(object):
    def __init__(self):
        ...
        self.context["_mcctest"] = sys.modules[__name__]
