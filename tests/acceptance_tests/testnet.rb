...
module BitShares
  ...
  class TestNet
    ...
    def initialize(logger = nil)
      ...
      ENV['MCC_BUILD'] = '../..' unless ENV['MCC_BUILD']
      @client_binary = ENV['MCC_BUILD'] + '/programs/client/mccsharestestnet_client'
      @client_binary = ENV['MCC_BUILD'] + '/programs/client/devshares_client' unless File.exist?(@client_binary)
      raise @client_binary + ' not found, please set MCC_BUILD env variable if you are using out of source builds' unless File.exist?(@client_binary)
    end
