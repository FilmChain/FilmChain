...
const static char*                                          WEB_UPDATES_MANIFEST_URL = "https://mccshares.org/manifest.json";
const static uint8_t                                        WEB_UPDATES_SIGNATURE_REQUIREMENT = 2;
const static std::unordered_set<mcc::blockchain::address>   WEB_UPDATES_SIGNING_KEYS ({
    mcc::blockchain::address( MCC_ADDRESS_PREFIX + std::string( "29Q5JSk35JXqLhdDeYxjtFNveEuavHacJ" ) ),
    mcc::blockchain::address( MCC_ADDRESS_PREFIX + std::string( "2xE2fG2uSKRp6TUZJ5rhucLwTKHi3r3oo" ) ),
    mcc::blockchain::address( MCC_ADDRESS_PREFIX + std::string( "HGPxYjgsDuhtCineuaC4P4r9jZWMBue1W" ) ),
    mcc::blockchain::address( MCC_ADDRESS_PREFIX + std::string( "62VST9FZZVMtTKurzzfpK9hp9sijQjkT3" ) )
});
...
struct WebUpdateManifest
{
    struct UpdateDetails
    {
        ...
        //Full URL (i.e. https://mccshares.org/toolkit/updates/0.2.4-c.pak)
        //to update package.
