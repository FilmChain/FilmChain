...
nv.models.mcccBar = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var wrap = d3.select(this).selectAll('g.nv-wrap.nv-mcccBar').data([data[0].values]);
      var wrapEnter = wrap.enter().append('g').attr('class', 'nvd3 nv-wrap nv-mcccBar');
      var defsEnter = wrapEnter.append('defs');
      var gEnter = wrapEnter.append('g');
      var g = wrap.select('g');
