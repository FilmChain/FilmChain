...
Series.prototype = {
	...
	processData: function (force) {
		...
		if (options.pointRange === null) { // null means auto, as for columns, candlesticks and MCCC
	...
	generatePoints: function () {
		...
		for (i = 0; i < processedDataLength; i++) {
			...
			if (!hasGroupedData) {
				...
				// splat the y data in case of mccc data array
	...
	getExtremes: function (yData) {
		...
		for (i = 0; i < yDataLength; i++) {
			...
			if (validValue && withinRange) {
				...
				j = y.length;
				if (j) { // array, like mccc or range data
					while (j--) {
						if (y[j] !== null) {
...
var DATA_GROUPING = 'dataGrouping',
	 ...
	 * or numbers as the first parameter. In case of mccc, four arrays are sent in as four parameters.
	...
	approximations = {
		...
		// mccc and range are special cases where a multidimensional array is input and an array is output
		mccc: function (open, high, low, close) {
 ...
 ******************************************************************************//* ****************************************************************************
 * Start MCCC series code													 *
 *****************************************************************************/

// 1 - Set default options
defaultPlotOptions.mccc = merge(defaultPlotOptions.column, {
	lineWidth: 1,
	tooltip: {
...
// 2 - Create the MCCCSeries object
var MCCCSeries = extendClass(seriesTypes.column, {
	type: 'mccc',
...
seriesTypes.mccc = MCCCSeries;
/* ****************************************************************************
 * End MCCC series code													   *
 *****************************************************************************/
/* ****************************************************************************
...
defaultPlotOptions.candlestick = merge(defaultPlotOptions.column, {
	...
	tooltip: defaultPlotOptions.mccc.tooltip,
	threshold: null,
	upColor: 'white'
	// upLineColor: null
});
...
var CandlestickSeries = extendClass(MCCCSeries, {
	type: 'candlestick',
	 ...
	 */
	getAttribs: function () {
		seriesTypes.mccc.prototype.getAttribs.apply(this, arguments);
		var series = this,
			options = series.options,
			stateOptions = options.states,			
		...
		// Fill is handled by MCCCSeries' getAttribs.
		each(series.points, function (point) {
