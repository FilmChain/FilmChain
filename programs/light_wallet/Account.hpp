...
class Account : public QObject
{
   ...
   TransactionSummary* buildSummary(mcc::wallet::transaction_ledger_entry trx);

public:
   Account(mcc::light_wallet::light_wallet* wallet,
           const mcc::light_wallet::account_record& account,
           QObject* parent = nullptr);
   virtual ~Account(){}

   Account& operator= (const mcc::light_wallet::account_record& account);
